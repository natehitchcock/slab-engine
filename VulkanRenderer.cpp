...
void VulkanRenderer::DestroyDebugReportCallbackEXT(VkInstance instance, VkDebugReportCallbackEXT callback,
	const VkAllocationCallbacks* pAllocator)
{
...
{ { -0.5f, 0.5f },{ 0.0f, 0.0f, 1.0f } }
		...
		VDeleter<VkBuffer>& buffer, VDeleter<VkDeviceMemory>& bufferMemory)
	{
		...
		// [TODO] Should create a memory manager for vulkan buffers, to avoid over allocation
